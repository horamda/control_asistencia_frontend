  ...
  AttendanceHomeActionViewData build({
    ...
    return AttendanceHomeActionViewData(
      ...
      quickActions: [
        ...
        AttendanceHomeActionSpec(
          intent: AttendanceHomeActionIntent.openProfile,
          label: 'Mi perfil',
          icon: Icons.person_outline,
          enabled: historyEnabled,
        ),
        AttendanceHomeActionSpec(
          intent: AttendanceHomeActionIntent.openBiometricSettings,
          label: 'Sesion y sonido',
          icon: Icons.fingerprint,
          enabled: historyEnabled,
        ),
        AttendanceHomeActionSpec(
          intent: AttendanceHomeActionIntent.openStats,
          label: 'Estadisticas',
          icon: Icons.insights_outlined,
          enabled: historyEnabled,
        ),
        AttendanceHomeActionSpec(
          intent: AttendanceHomeActionIntent.openSecurityEvents,
          label: 'Seguridad',
